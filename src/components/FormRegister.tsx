        ...
        <div className='flex flex-col items-center mt-10 gap-8 px-4 sm:px-0'>
            ...
            <form autoComplete="off" className='w-full sm:w-80' onSubmit={handleSubmit(onSubmit)}>
                <div className='flex flex-col'>
                    ...
                    <input {...register("name", { required: "Name is required" })} type="text" id="name" name="name" placeholder="Nhập tên...."
                ...
                <div className='flex flex-col mt-4'>
                    ...
                    <input {...register("phone", { required: "Phone number is required" })} type="text" id="phone" name="phone" placeholder="Nhập số điện thoại...."
                        className='mt-2 p-2 border-2 border-pink-400 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-pink-500 w-full' />
                </div>
                <div className='flex flex-col mt-4'>
                    <div className='flex flex-row'>
                ...
                <div className='flex flex-col mt-4'>
                    ...
                    })} type="password" id="confirmPassword" name="confirmPassword" placeholder="Xác nhận mật khẩu...."
                        className='mt-2 p-2 border-2 border-pink-400 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-pink-500 w-full' />
                </div>
